...
def plot_successrate(trust, l_x, h_y, plot=True, verbose=True):
    if final_time == 0:
    ...
    try:
        ...
        if verbose: print('Success rate data loaded!')

    except:
        pplot_first_passagerint('No success rate data found!')
        sys.exit()
...
if __name__ == '__main__':
    success_rate_source = plot_successrate(trust, l_x, h_y)
