...
def plot_successrate(trust, l_x, h_y, plot=True):
    if final_time == 0:
    ...
    if data_found:
        ...
        success_rate_source = np.nan

    return success_rate_source, data_found

if __name__ == '__main__':
    success_rate_source, data_found = plot_successrate(trust, l_x, h_y)
