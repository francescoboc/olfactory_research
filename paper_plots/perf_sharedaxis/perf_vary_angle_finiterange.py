...
for mu in mus:
    ...
    for trust in trusts:
        ...
        try:
            ...
            print(f'mu {mu:.2f}, trust {trust} missing')
...
# plt.title(r'Varying initial angle $\theta$ ($H=0, \sigma=0$)')
...
ax1.legend(handles=legend_handles, handletextpad=0.0, title=r'Angle $\theta$')

ax1.text(0.015, 0.5, r'$(b)$', transform=ax1.transAxes, fontsize=15, color='black', ha='left', va='center')

# ax1.set_ylim(-1.41, 52.03)

show_and_check_ipython()

# filename = 'perf_angle_finiterange.pdf'
