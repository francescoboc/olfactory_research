...
filename = rf'optimal_beta_map_angle{mu:.2f}_std{sigma:.2f}'
extension = '.png'
savefig = True
...
if savefig: plt.gcf().savefig(save_directory + filename + '_rate' + extension)
...
if savefig: plt.gcf().savefig(save_directory + filename + '_fpt' + extension)
