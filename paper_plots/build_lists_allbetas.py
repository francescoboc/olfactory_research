...
for trust in trusts:
    ...
    try:
        ...
        success_rate_com_theo = np.load(f'{hexbin_folder}/com_fulltheo_betav0_successrate_gridsize{gridsize}_offset{offset}.npy', allow_pickle=True)
    except:
        data_found = False
...
if data_found:
    ...
    np.save(f'{dicts_folder}/com_fulltheo_betav0_rate_betas_gridsize{gridsize}_offset{offset}', rate_betas_com_theo)
